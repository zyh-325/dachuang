...
def read_dataset():
    train_df = pd.read_csv(r"D:\FG-SSL-main\dataset\data\ISIC-2017_Training_Part3_GroundTruth.csv")
    valid_df = pd.read_csv(r"D:\FG-SSL-main\dataset\data\ISIC-2017_Validation_Part3_GroundTruth.csv")
    test_df = pd.read_csv(r"D:\FG-SSL-main\dataset\data\ISIC-2017_Test_v2_Part3_GroundTruth.csv")

    train_images_dir = r"D:\FG-SSL-main\dataset\data\ISIC-2017_Training_Data"
    valid_images_dir = r"D:\FG-SSL-main\dataset\data\ISIC-2017_Validation_Data"
    test_images_dir =r"D:\FG-SSL-main\dataset\data\ISIC-2017_Test_v2_Data"
...
def isicseven_loader(args):
    ...
    test_dl = DataLoader(test_ds, batch_size = args.batchsize, pin_memory = False, shuffle = True, num_workers = 8)
    ...
    label_train_dl = DataLoader(train_ds, batch_size = args.batchsize, pin_memory = False, shuffle = True, num_workers = 8)
    ...
    unlabel_dl = DataLoader(valid_ds, batch_size = args.batchsize, pin_memory = False, shuffle = True, num_workers = 8)
