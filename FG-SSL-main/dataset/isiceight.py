...
from isicseven import customDataset
from utils import *
...
def isiceight_loader(args):
    """
    return traintabledataset and testdataset. 
    If you want change table, check for utils.get_table
    """
    train_df = pd.read_csv("D:\FG-SSL-main\dataset\data\ISIC2018_Task3_Training_LesionGroupings.csv")
    train_df["image"] ="D:\FG-SSL-main\dataset\data\ISIC2018_Task3_Training_Input" + train_df["image"] + ".jpg"
    ...
    ssl_train_dl = DataLoader(train_ds, batch_size = args.batchsize, pin_memory=False, shuffle=True, num_workers=8)
    ssl_test_dl = DataLoader(test_ds, batch_size = args.batchsize, pin_memory=False, shuffle=True, num_workers=8)
